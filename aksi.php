...
// require_once'fungsi/fungsi_komentar.php';
    ...
    if($mod=='tempat_tambah'){
        ...
        $komentar = esc_field($_POST['komentar']);
        ...
        if($nama_tempat=='' || $gambar['name']=='' || $lat=='' || $lng=='' || $lokasi=='')
            ...
            $db->query("INSERT INTO tb_tempat (nama_tempat, gambar, link, lat, lng, lokasi, keterangan, komentar) 
                    VALUES ('$nama_tempat', '$file_name', '$link' ,'$lat', '$lng', '$lokasi', '$keterangan','$komentar')");                       
...
//review
    if($mod=='review_tambah'){
        $id_tempat = $_POST['id_tempat'];
        $nama = $_POST['nama'];
        $komentar = $_POST['komentar'];
        $db->query("INSERT INTO tb_review (id_tempat, nama, komentar) 
                    VALUES ('$id_tempat','$nama','$komentar')");                       
    ...
    if($mod=='faq'){
        ...
        $email = $_POST['email'];
        $pesan = $_POST['pesan'];
        $db->query("INSERT INTO tb_faq (nama, email, pesan) 
                    VALUES ('$nama','$email','$pesan')");                       
            redirect_js("index.php?m=contact");
    } 
